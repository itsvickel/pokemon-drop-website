...
export const getStaticProps: GetStaticProps<Props> = async () => {
  try {
    ...
    console.error("[mtg/singles] getStaticProps failed:", err);
    return {
...
export default function MtgSinglesPage(props: Props) {
  return <SinglesPage tcg="mtg" initialProducts={props.initialProducts} />;
}
