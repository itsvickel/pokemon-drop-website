...
export const getStaticProps: GetStaticProps<Props> = async () => {
  try {
    ...
    const scoped = scopeForView(feed.products, "sealed");
    return {
      props: {
    ...
    console.error("[pokemon/deals] getStaticProps failed:", err);
    return {
...
export default function PokemonDealsPage(props: Props) {
  return <ProductsPage tcg="pokemon" view="deals" {...props} />;
}
