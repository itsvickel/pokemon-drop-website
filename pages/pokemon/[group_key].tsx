...
export default function PokemonProductPage({ product, groupKey }: Props) {
  return <ProductDetailPage tcg="pokemon" groupKey={groupKey} initialProduct={product} />;
}
...
export const getStaticProps: GetStaticProps<Props> = async ({ params }) => {
  ...
  try {
    const product = await loadProduct(TCG_CONFIGS.pokemon, groupKey);
    ...
    console.error("[pokemon/group_key] getStaticProps failed:", err);
