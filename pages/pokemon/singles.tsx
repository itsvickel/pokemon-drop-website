...
export const getStaticProps: GetStaticProps<Props> = async () => {
  try {
    ...
    console.error("[pokemon/singles] getStaticProps failed:", err);
    return {
...
export default function PokemonSinglesPage(props: Props) {
  return <SinglesPage tcg="pokemon" initialProducts={props.initialProducts} />;
}
